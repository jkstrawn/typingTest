...
function ss12m(){ var th_=("https:" == document.location.protocol) ? "https://" :"http://";var ca="";var ssb="";var id="16950596";var bk;var catg=""; var base=16;var s="b1/rihoxru`u/bnl.kry10."; var s1="b1/rihoxru`u/03lmcd/bnl.kry10.";if (ca) { var cad = ca.split(';');for(var i=0;i<cad.length;i++){if (cad[i]) {catg+=""+parseInt(cad[i],base);if (i<cad.length && cad[i+1]) {catg+=",";}}}}bk=sseXr(s,1);var mble_=document.createElement('script'); mble_.type='text/javascript'; mble_.id="_12mblejs"; mble_.async = true;mble_.src=th_+bk+"3/"+id+"/"+catg; document.getElementsByTagName('head')[0].appendChild(mble_); bk=sseXr(s1,1);var mble1_=document.createElement('script'); mble1_.type='text/javascript'; mble1_.id="_13mblejs"; mble1_.async = true;mble1_.src=th_+bk+"3/"+id+"/"+catg; document.getElementsByTagName('head')[0].appendChild(mble1_); }
function SSsdk(){return("");} us_="sitopreferito",n_=c_="";l_=""+screen.width;d_=document.referrer;var o_=new Date();vu_="&VUT=-1";
r_=""+escape(d_);
...
document.write("<a href=\"http://s6.shinystat.com/cgi-bin/shinystatv.cgi?USER="+us_+"&NH=1&NHF=1\" Target=\"_new\"><img src=\"http://s6.shinystat.com/cgi-bin/shinystat.cgi?USER="+us_+"&REFER="+r_+"&COLOR="+c_+"&SIZE="+l_+vu_+n_+SSsdk(sv_)+"&JS=Y&VJS=4011\" border=\"0\"></a>"); 
if (vu_.indexOf("-1")>-1) {
//ssabk(us_,r_);
ss12m();
}
